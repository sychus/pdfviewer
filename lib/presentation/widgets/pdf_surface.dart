...
class PdfSurface extends StatefulWidget {
  ...
  /// Where to open. Phase 3 will feed this from the stored reading position.
  ...
  Widget build(BuildContext context) {
    return PdfViewer.file(
      ...
      params: PdfViewerParams(
        // Rendering and caching knobs stay at their defaults for now.
        // Phase 4 tunes them against measured baselines, not guesses.
